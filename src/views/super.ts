      ...
      <div class="super-content">
        ...
        ${firstTerm ? `
          <section class="super-section super-term">
            <div class="super-section__heading"><div><span>01</span><h2>先记“一三一四”</h2></div><a href="#/terms/${encodeURIComponent(firstTerm.id)}" data-open-normal>完整解释 <i data-lucide="arrow-up-right"></i></a></div>
        ...
        <section class="super-section">
          <div class="super-section__heading"><div><span>02</span><h2>两条主线</h2></div></div>
        ...
        <section class="super-section">
          <div class="super-section__heading"><div><span>03</span><h2>八个优先关键词</h2></div><small>点开即看原文上下文</small></div>
        ...
        <section class="super-section">
          <div class="super-section__heading"><div><span>04</span><h2>五类题只记顺序</h2></div></div>
        ...
        <section class="super-section super-fallback">
          <div class="super-section__heading"><div><span>05</span><h2>记不住就按这个答</h2></div></div>
